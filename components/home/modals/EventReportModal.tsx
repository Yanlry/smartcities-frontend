// Chemin : src/components/events/EventReportModal.tsx
...
// ✅ CATÉGORIES ADAPTÉES AUX ÉVÉNEMENTS
const REPORT_CATEGORIES = [
  {
    id: "inappropriate_content",
    label: "Contenu inapproprié",
    icon: "warning-outline",
    description: "Description offensante ou déplacée",
  },
  {
    id: "spam",
    label: "Spam ou arnaque",
    icon: "ban-outline",
    description: "Événement frauduleux ou publicité déguisée",
  },
  {
    id: "misleading_info",
    label: "Informations trompeuses",
    icon: "alert-circle-outline",
    description: "Fausses informations sur l'événement",
  },
  {
    id: "dangerous_activity",
    label: "Activité dangereuse",
    icon: "flash-outline",
    description: "Événement qui pourrait être dangereux",
  },
  {
    id: "copyright",
    label: "Violation de droits",
    icon: "document-text-outline",
    description: "Utilisation non autorisée d'images ou contenu",
  },
  {
    id: "cancelled",
    label: "Événement annulé",
    icon: "close-circle-outline",
    description: "Événement annulé mais toujours visible",
  },
  {
    id: "other",
    label: "Autre motif",
...
/**
 * ✅ MODAL DE SIGNALEMENT MODERNE POUR LES ÉVÉNEMENTS
 */
export const EventReportModal: React.FC<EventReportModalProps> = memo(
  ({ isVisible, onClose, onSendReport, eventTitle = "cet événement" }) => {
    // États locaux
    ...
    const handleSendReport = useCallback(async () => {
      ...
      try {
        ...
        Alert.alert(
          "Signalement envoyé",
          "Merci de contribuer à la sécurité de notre communauté. Notre équipe examinera cet événement rapidement.",
          [
            {
              text: "Fermer",
              onPress: onClose,
      ...
      <View style={styles.stepContainer}>
        ...
        <View style={styles.postInfoContainer}>
          <Ionicons
            ...
            color={COLORS.neutral.text.hint}
          />
          <Text style={styles.postInfoText}>Événement : {eventTitle}</Text>
        </View>
      </View>
    );
...
EventReportModal.displayName = "EventReportModal";
...
const styles = StyleSheet.create({
  ...
  progressStepActive: { backgroundColor: COLORS.primary.main },
  progressStepText: {
    fontSize: 14,
    fontWeight: "600",
    color: COLORS.neutral.text.hint,
  },
  progressStepTextActive: { color: COLORS.primary.contrast },
  progressLine: {
    flex: 1,
    height: 2,
    backgroundColor: COLORS.neutral.border,
  ...
  categoryLabelSelected: { color: COLORS.primary.main },
  categoryDescription: {
    fontSize: 13,
    color: COLORS.neutral.text.secondary,
    lineHeight: 18,
  ...
  charCountWarning: { color: COLORS.danger.main },
  postInfoContainer: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: COLORS.neutral.background,
